...
<body style="background-image: linear-gradient(to bottom, #5399C2, #B8C2A9); background-size: cover; padding-bottom: 578px;  text-shadow: #ffffff 0 0 1px">

<h1 align="center"><font face="Times New Roman" color="#20269E" size="7">Изменение данных клиента</font></h1>

<c:url var="saveUrl" value="/client/edit?id=${clientAttribute.id}" />
