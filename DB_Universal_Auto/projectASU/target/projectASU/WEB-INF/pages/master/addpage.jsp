...
<h1 align="center"><font face="Times New Roman" color="#20269E" size="7">Добавление нового мастера</font></h1>

<c:url var="saveUrl" value="/master/add" />
<form:form modelAttribute="masterAttribute" method="POST" action="${saveUrl}">
    <table align="center">
        ...
        <tr>
            ...
            <td><form:input path="date_of_birth" pattern="^[0-3][0-9]\.[0-1][0-9]\.[1-2][0-9][0-9][0-9]$"/></td>
        </tr>

        <tr>
            <td><form:label path="start_date"><font face="Times New Roman" color="#20269E" size="5">Дата начало работы:</font></form:label></td>
            <td><form:input path="start_date" pattern="^[0-3][0-9]\.[0-1][0-9]\.[1-2][0-9][0-9][0-9]$"/></td>
        </tr>
